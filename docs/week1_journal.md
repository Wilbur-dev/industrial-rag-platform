...
| Latency                                                                                                                                 |                                                                                                                                                                                                                                     |
| 问题                                                                                                                                      |                                                                                                                                                                                                                                     |
| 截图                                                                                                                                      | `day1-health.png`, `day1-logs.png`                                                                                                                                                                                                  |
...
| 截图                                                                                                                                                      | `day2-ingest-file-response.png`, `day2-ingest-upload-response.png` |
...
| 截图                                                                                                                                 | `day3-chunking-test.png`, `day3-chunk-params.png`, `day3-chunk-count-compare.png` |
...
| 截图      | `day4-loading-model-log.png`, `day4-embed-latency.png`, `day4-embed-batch-optional.png` |
...
| 截图  | `day5-qdrant-dashboard.png` - Qdrant dashboard `localhost:6333/dashboard`, `day5-qdrant-healthcheck.png` |
...
| 截图            | `day6-query-with-citations.png` - `/api/v1/query` 含 citations 的 JSON, `day6-topk-compare-top1.png`, `day6-topk-compare-top2.png`, `day6-no-context.png` |
